...
let IconsousuoJiagexia1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      ...
      <Path
        ...
        fill={getIconColor(color, 1, '#B6BECA')}
      />
    </Svg>
  );
};

IconsousuoJiagexia1X.defaultProps = {
  size: 18,
};

IconsousuoJiagexia1X = React.memo ? React.memo(IconsousuoJiagexia1X) : IconsousuoJiagexia1X;

export default IconsousuoJiagexia1X;
