...
let Icontupianhuise1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Icontupianhuise1X.defaultProps = {
  size: 18,
};

Icontupianhuise1X = React.memo ? React.memo(Icontupianhuise1X) : Icontupianhuise1X;

export default Icontupianhuise1X;
