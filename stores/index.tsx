...
import GoodsPublishState from "./goods/publish";
import LeadsPublishState from "./leads/publish";
import LeadsSearchState from "./leads/search";
...
const stores = {
    ...
    goodsPublishState: new GoodsPublishState(),
    searchState: new SearchState(),
    leadsPublishState: new LeadsPublishState(),
    leadsSearchState: new LeadsSearchState(),
