...
import { NavigationState, Route, TouchableItem } from 'react-native-tab-view';
...
export default class TabBarItem<T extends Route> extends React.Component<Props<T>> {
    ...
    render() {
        ...
        if (renderLabel) {
            ...
            label = (
                <View>
                    ...
                    {!isFocused && <Animated.View style={{ opacity: inactiveOpacity }}>
                        {inactiveLabel}
                    </Animated.View>
                    }
                    {isFocused &&
        ...
        const tabContainerStyle: ViewStyle | null = isWidthSet ? null : {};
