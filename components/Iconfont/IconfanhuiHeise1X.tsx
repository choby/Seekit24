...
let IconfanhuiHeise1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconfanhuiHeise1X.defaultProps = {
  size: 18,
};

IconfanhuiHeise1X = React.memo ? React.memo(IconfanhuiHeise1X) : IconfanhuiHeise1X;

export default IconfanhuiHeise1X;
