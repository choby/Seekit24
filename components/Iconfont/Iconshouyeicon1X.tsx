...
let Iconshouyeicon1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconshouyeicon1X.defaultProps = {
  size: 18,
};

Iconshouyeicon1X = React.memo ? React.memo(Iconshouyeicon1X) : Iconshouyeicon1X;

export default Iconshouyeicon1X;
