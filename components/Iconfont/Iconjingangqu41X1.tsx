...
let Iconjingangqu41X1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconjingangqu41X1.defaultProps = {
  size: 18,
};

Iconjingangqu41X1 = React.memo ? React.memo(Iconjingangqu41X1) : Iconjingangqu41X1;

export default Iconjingangqu41X1;
