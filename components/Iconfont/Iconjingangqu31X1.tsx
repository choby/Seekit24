...
let Iconjingangqu31X1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconjingangqu31X1.defaultProps = {
  size: 18,
};

Iconjingangqu31X1 = React.memo ? React.memo(Iconjingangqu31X1) : Iconjingangqu31X1;

export default Iconjingangqu31X1;
