...
let Iconwodeicon2: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconwodeicon2.defaultProps = {
  size: 18,
};

Iconwodeicon2 = React.memo ? React.memo(Iconwodeicon2) : Iconwodeicon2;

export default Iconwodeicon2;
