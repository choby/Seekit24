...
let Iconjingangqu221X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconjingangqu221X.defaultProps = {
  size: 18,
};

Iconjingangqu221X = React.memo ? React.memo(Iconjingangqu221X) : Iconjingangqu221X;

export default Iconjingangqu221X;
