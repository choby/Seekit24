...
let IconlieJinru1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconlieJinru1X.defaultProps = {
  size: 18,
};

IconlieJinru1X = React.memo ? React.memo(IconlieJinru1X) : IconlieJinru1X;

export default IconlieJinru1X;
