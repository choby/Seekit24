...
let Iconfabuhao1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconfabuhao1X.defaultProps = {
  size: 18,
};

Iconfabuhao1X = React.memo ? React.memo(Iconfabuhao1X) : Iconfabuhao1X;

export default Iconfabuhao1X;
