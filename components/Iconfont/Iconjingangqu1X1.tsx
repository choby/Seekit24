...
let Iconjingangqu1X1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconjingangqu1X1.defaultProps = {
  size: 18,
};

Iconjingangqu1X1 = React.memo ? React.memo(Iconjingangqu1X1) : Iconjingangqu1X1;

export default Iconjingangqu1X1;
