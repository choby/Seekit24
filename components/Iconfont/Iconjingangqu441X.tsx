...
let Iconjingangqu441X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconjingangqu441X.defaultProps = {
  size: 18,
};

Iconjingangqu441X = React.memo ? React.memo(Iconjingangqu441X) : Iconjingangqu441X;

export default Iconjingangqu441X;
