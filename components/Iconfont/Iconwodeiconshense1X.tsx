...
let Iconwodeiconshense1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconwodeiconshense1X.defaultProps = {
  size: 18,
};

Iconwodeiconshense1X = React.memo ? React.memo(Iconwodeiconshense1X) : Iconwodeiconshense1X;

export default Iconwodeiconshense1X;
