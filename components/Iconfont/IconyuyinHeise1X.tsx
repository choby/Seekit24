...
let IconyuyinHeise1X: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconyuyinHeise1X.defaultProps = {
  size: 18,
};

IconyuyinHeise1X = React.memo ? React.memo(IconyuyinHeise1X) : IconyuyinHeise1X;

export default IconyuyinHeise1X;
